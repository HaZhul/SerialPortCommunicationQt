...
void MainWindow::onTimerInterrupt(){
    ...
    static QList<double> value3;
    static QList<double> value4;
    zegar++;
    czas=zegar*0.1;
    ...
    ui->wykres1->yAxis->setRange(0, 260);
    ui->wykres1->replot();
    ...
    ui->wykres2->yAxis->setRange(0, 110);
    ui->wykres2->replot();

    ui->wykres3->graph(0)->setData(time.toVector(),value4.toVector());
    if(zegar<25) {
            ui->wykres3->xAxis->setRange(0,5);
        } else {
            ui->wykres3->xAxis->setRange(czas-2.5,czas+2.5);
        }
    ui->wykres3->yAxis->setRange(0, 110);
    ui->wykres3->replot();

    ui->wykres4->graph(0)->setData(time.toVector(),value3.toVector());
    if(zegar<25) {
            ui->wykres4->xAxis->setRange(0,5);
        } else {
            ui->wykres4->xAxis->setRange(czas-2.5,czas+2.5);
        }
    ui->wykres4->yAxis->setRange(0, 110);
    ui->wykres4->replot();
